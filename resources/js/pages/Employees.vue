...
const tabs = [
    ...
    {id: 'documents', name: 'Documentos Trabalhistas'},
    {id: 'contact', name: 'Endereço e Contato'},
    {id: 'bank', name: 'Dados Bancários'},
    {id: 'contract', name: 'Informações Contratuais'},
    {id: 'health', name: 'Saúde e Segurança'},
    {id: 'dependents', name: 'Dependentes'},
    {id: 'attachments', name: 'Anexos'},
]
...
const getFileIcon = (tipo: string) => {
    ...
    if (tipo.includes('excel') || tipo.includes('sheet')) return 'file-spreadsheet';
    if (tipo.includes('presentation') || tipo.includes('powerpoint')) return 'file-presentation';
    return 'file';
}
            ...
            <div class="flex flex-1 flex-col overflow-hidden">
                <main class="flex-1 overflow-auto p-4 md:p-6">
                    ...
                    <Header v-if="!showEmployeeForm" class="text-black mb-10">
                        <div class="mx-auto flex justify-between items-center">
                            ...
                            <button
                                ...
                                class="bg-gray-900 cursor-pointer hover:bg-gray-800 text-white px-4 py-2 rounded-md flex items-center"
                            >
                    ...
                    <div v-else>
                        ...
                        activeTab === tab.id
                          ? 'border-b-2 border-gray-800 bg-gray-100 rounded-t text-gray-600'
                        ...
                        <div class="p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input
                                            ...
                                            class="w-full p-2 border rounded-md focus:ring-2 focus:ring-gray-500 focus:border-gray-500"
                                        />
                                        <p class="text-xs text-gray-500">Se aplicável à função</p>
                                    </div>
                            ...
                            <div v-if="activeTab === 'dependents'" class="space-y-6">
                                ...
                                <div v-if="formData.dependentes.length === 0" class="text-center py-8 text-gray-500">
                                    Nenhum dependente cadastrado
                                </div>

                                <div v-for="(dependente, index) in formData.dependentes" :key="index"
                            ...
                            <div v-if="activeTab === 'attachments'" class="space-y-6">
                                ...
                                <div v-if="formData.anexos.length === 0" class="text-center py-8 text-gray-500">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 h-10 w-10 flex items-center justify-center">
                                                        <FileTextIcon v-if="anexo.tipo.includes('pdf')" class="h-6 w-6 text-red-500" />
                                                        <ImageIcon v-else-if="anexo.tipo.includes('image')" class="h-6 w-6 text-blue-500" />
                                                        <FileSpreadsheetIcon v-else-if="anexo.tipo.includes('excel') || anexo.tipo.includes('sheet')" class="h-6 w-6 text-green-500" />
                                                        <File v-else-if="anexo.tipo.includes('presentation') || anexo.tipo.includes('powerpoint')" class="h-6 w-6 text-orange-500" />
