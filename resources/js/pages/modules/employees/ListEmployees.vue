                        ...
                        <div class="inline-flex items-center">
                            <label class="flex items-center cursor-pointer relative">
                                <input :checked="isAllSelected"
                                       ...
                                       type="checkbox" class="peer h-6 w-6 cursor-pointer transition-all appearance-none rounded-full shadow hover:shadow-md border-2 border-muted checked:bg-checked checked:border-checked" />
